...
c ::: INPUTS/OUTPUTS:
c :::
c ::: holder_l1, holder_l2, holder_h1, holder_h2=> index extent of place holder array
c ::: lo(2)    <= lower index limits
c ::: hi(2)    <= upper index limits
c ::: -----------------------------------------------------------
      subroutine SET_LOHI(holder_l1, holder_l2, holder_h1, holder_h2, lo
     &, hi)
...
c ::: hi(2)         => upper index limits
c ::: -----------------------------------------------------------
      subroutine SET_ARGS(holder_l1, holder_l2, holder_h1, holder_h2, lo
     &, hi)
